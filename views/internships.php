...
<div class="container internship-hero">
    ...
    <p>Launch your career with hands-on experience. Learn real-world technologies and build your professional portfolio
        with industry mentors.</p>
</div>
                ...
                <div class="internship-info-card">
                    <div class="info-card-inner">
                        ...
                        <div class="info-card-content">
                            ...
                            <p>Our internship program is designed to accelerate your professional development through
                                practical, hands-on experience in real-world projects.</p>
                            <ul class="info-card-list">
                                <li><strong>Project-Based Learning:</strong> Work on live projects with real clients and
                                    real impact on your resume</li>
                                <li><strong>Hands-On Experience:</strong> Master the latest technologies and industry
                                    best practices from day one</li>
                                <li><strong>Expert Mentorship:</strong> Get guidance from experienced professionals who
                                    care about your growth</li>
                                <li><strong>Career Acceleration:</strong> Build a portfolio that stands out to employers
                                    and opens doors</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card h-100 internship-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-grid mt-auto">
                                    <a href="/apply/internship/<?php echo $internship['id']; ?>" class="btn apply-btn">
