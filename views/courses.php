...
<section class="py-5" style="margin-top: 80px;">
    <div class="container">
        ...
        <?php if (!empty($active_coupons)): ?>
                ...
                <?php foreach ($active_coupons as $coupon): ?>
                    ...
                    <div class="coupon-banner d-flex flex-wrap align-items-center justify-content-between gap-3 p-4 rounded-4 mb-3 shadow-sm">
                        <div class="d-flex align-items-center gap-3">
                            <div class="coupon-icon d-flex align-items-center justify-content-center rounded-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div class="coupon-code-box" id="coupon-code-<?php echo $coupon['id']; ?>">
                                <span class="coupon-code-text fw-bold"><?php echo htmlspecialchars($coupon['code']); ?></span>
                            </div>
            ...
            .coupon-code-text { color: #fff; font-size: 1.1rem; }
        ...
        <div class="text-center mb-5">
            ...
            <p class="lead text-muted">Master the latest technologies with our industry-aligned curriculum - from
                foundation to advanced level with job ready skillset.</p>
        </div>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?php if (!empty($course['image'])): ?>
                                            <div class="mb-3">
                                                <img src="/assets/images/<?php echo $course['image']; ?>"
                                                    alt="<?php echo $course['name']; ?>" class="img-fluid rounded"
                                                    style="max-height: 200px; width: 100%; object-fit: cover;">
                                            </div>
                                    <?php endif; ?>
                                    <div class="mb-4">
                                        <span
                                            class="badge bg-<?php echo $course['color']; ?>"><?php echo $course['level']; ?></span>
                                        <span class="badge bg-secondary ms-2"><?php echo count($course['curriculum']); ?>
                                            Modules</span>
                                    </div>
                                        ...
                                        <?php foreach ($course['curriculum'] as $modIndex => $module): ?>
                                                <div class="curriculum-module mb-4">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <div class="module-number bg-<?php echo $course['color']; ?> text-white rounded-circle d-flex align-items-center justify-content-center me-3"
                                                    ...
                                                    <div class="module-topics ms-5">
                                                        <?php foreach ($module['topics'] as $topic): ?>
                                                                <div class="d-flex align-items-center mb-2">
                                                                    <i class="fas fa-check-circle text-<?php echo $course['color']; ?> me-2"
                                                ...
                                                <?php if ($modIndex < count($course['curriculum']) - 1): ?>
                                                        <div class="curriculum-line bg-<?php echo $course['color']; ?>-subtle mx-5 mb-4"
...
<section class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="lead text-muted">Bundle courses together and save big! Our recommended learning pathways for your
                career success.</p>
            <span class="badge bg-warning text-dark fs-6 mt-2"><i class="fas fa-star me-1"></i> Best Value
                Programs</span>
        </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card h-100 combo-card shadow-sm position-relative">
                                    ...
                                    <div class="card-body p-4 <?php echo !empty($track['badge']) ? 'pt-5' : ''; ?>">
                                        <h5 class="card-title fw-bold text-center mb-3"><?php echo htmlspecialchars($track['name']); ?>
                                        </h5>
                                        ...
                                        <p class="card-text text-muted small text-center mb-3">
                                            <?php echo htmlspecialchars($track['summary'] ?? ''); ?></p>
                                        ...
                                        <div class="text-center mb-3">
                                            <?php if ($track['original_price'] > 0 && $track['original_price'] > $track['price']):
                                                ...
                                                ?>
                                                    <span
                                                        class="combo-original-price">₹<?php echo number_format($track['original_price']); ?></span>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center pt-3 border-top gap-3">
                                            ...
                                            <a href="/enroll?track=<?php echo urlencode($track['slug']); ?>"
                                                class="btn btn-<?php echo $track['badge_color']; ?> px-4"
